...
const BuisnessChange = () => {
  return (
    <section className="buisness-section w-full relative flex-col radius-yellow bg-custom-brown rounded-3xl mt-14 lg:mt-20 p-6">
            ...
            <div className="image-text-section flex flex-col lg:flex-row justify-center items-center w-full lg:w-3/4 space-y-4 lg:space-y-0">
              <div className="w-full lg:w-1/2 flex justify-center items-center p-4">
                <img
                  ...
                  alt="Updated"
                  className="rounded-3xl w-full h-auto lg:w-auto lg:h-auto xl:h-96"
                />
              </div>
              ...
              <div className="w-full lg:w-1/2 flex-col justify-center items-center p-4">
                <ul className="space-y-4 text-white text-lg sm:text-xl">
                  <li className="flex items-center space-x-2">
                    ...
                    <span className="p-1 sm:p-4 text-xl md:text-2xl">
                      Streamline operations for enhanced <b> efficiency</b> and <b> productivity.</b>
                    </span>
                  </li>
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span className="p-1 sm:p-4 text-xl md:text-2xl">
                      Elevate decision-making for <b> strategic growth</b> and <b> profitability.</b>
                    </span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <div className="bg-green-600 p-1 rounded-full">
                    ...
                    <span className="p-1 sm:p-4 text-xl md:text-2xl">
                      Cultivate a culture of <b>innovation</b> and <b>adaptability</b> to thrive in <b>dynamic markets.</b>{" "}
                    </span>
                  </li>
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span className="p-1 sm:p-4 text-xl md:text-2xl">
                      Propel your business towards <b>sustainable success</b> and <b>competitive advantage.</b>{" "}
                    </span>
                  </li>
                </ul>
                ...
                <div className="flex justify-center mt-8 sm:mt-8 sm:py-2 sm:px-2 ">
                <a href="https://rzp.io/l/badecisionmc"> <button className="bg-blue-600 text-white sm:text-xl font-bold py-2 px-2  sm:px-6 rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 flex items-center justify-between space-x-4">
